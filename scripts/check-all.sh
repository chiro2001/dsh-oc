...
bash tests/update-local-install.sh
...
if [[ "$E2E" == "1" ]]; then
  ...
  STABLE_E2E="e2e-api.sh e2e-api-attachment.sh e2e-cli-bin.sh e2e-tui-boot.sh e2e-tui-turn.sh e2e-tui-tools.sh \
    ...
    e2e-tui-agent-tab.sh e2e-tui-agent-lock.sh e2e-tui-preset-inherit.sh e2e-tui-queue-live.sh e2e-tui-subagent.sh e2e-tui-shell.sh e2e-recovery-consistency.sh"
  STABLE_E2E+=" e2e-recovery-crash.sh e2e-recovery-sse-reconnect.sh e2e-golden-trace.sh e2e-queued-order-repro.sh"
