	...
	return createUserMessage({
		content: [{
			...
			text: truncateUtf8([
				...
				`Command:\n${truncateUtf8(command, SHELL_CONTEXT_COMMAND_LIMIT_BYTES, `[command truncated for model context after ${SHELL_CONTEXT_COMMAND_LIMIT_BYTES} UTF-8 bytes]`)}`,
...
//# sourceMappingURL=http-Cqz0GJu3.js.map