...
//#region src/bridge/file-uploads.d.ts
declare const name = "@chiro2001/dsh-oc/file-uploads";
/**
 ...
 */
declare class OcFileUploads extends Service {
   ...
   */
  bindPrompt(agent: unknown, receiptIds: readonly string[], _requestId: string): Disposable & {
    commit(): void;
  };
