...
| `src/bridge/router.ts` | 18741fd feat(tui): make --dir switch the bridge working directory |
...
| `src/help.ts` | 402a641 feat(bridge): add /help slash command with shared capability summary |
